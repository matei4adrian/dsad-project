...
g.corelograma(matrice=calObs_df, dec=2,
              titlu='Corelograma a calitatii reprezentarii observatiilor pe axele componentelor principale')
...
g.corelograma(matrice=betha_df, dec=2,
              titlu='Corelograma contributiei observatiilor la varianta axelor componentelor principale')
...
g.corelograma(matrice=comunitati_df, dec=2,
              titlu='Corelograma comunitati (regasirea componentelor principale in variabilele initiale)')
